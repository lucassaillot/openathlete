          ...
          <table role="presentation" width="560" cellspacing="0" cellpadding="0" border="0" style="width:560px;max-width:560px;background:${brand.cardBg};border-radius:16px;overflow:hidden;box-shadow:0 2px 16px rgba(5,12,52,0.18);">
            <tr>
              <td style="padding:18px 24px;background:${brand.headerBg};border-bottom:1px solid ${brand.border};">
                <div style="color:${brand.fg};font-weight:700;font-size:16px;display:inline-flex;align-items:center;gap:10px;">
                  <img src="${brand.logoUrl}" alt="Team Running Rouxmesnil" width="32" height="32" style="display:inline-block;border:0;outline:none;" />
                  <span>Team Running Rouxmesnil</span>
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td style="padding:20px 28px;background:${brand.footerBg};border-top:1px solid ${brand.border};">
                <p style="margin:0;font-size:12px;color:${brand.muted};">© ${new Date().getFullYear()} Team Running Rouxmesnil — Tous droits réservés</p>
